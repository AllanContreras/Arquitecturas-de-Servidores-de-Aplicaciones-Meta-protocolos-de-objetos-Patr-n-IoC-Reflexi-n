...
## 7. Ciclo de vida con Maven y GitHub

### 7.1. Ciclo de vida Maven

- `mvn compile` → compila el código fuente.
- `mvn test` → ejecuta las pruebas (si se agregan).
- `mvn package` → genera el artefacto JAR en `target/`.

### 7.2. Manejo del repositorio en GitHub

Este proyecto se almacena en el repositorio:

- https://github.com/AllanContreras/Arquitecturas-de-Servidores-de-Aplicaciones-Meta-protocolos-de-objetos-Patr-n-IoC-Reflexi-n

Comandos típicos (resumen):
...
git commit -m "Implementación micro servidor e IoC de taller"

# Enviar cambios al repositorio remoto
git push origin main
```

> El commit inicial del laboratorio y el commit final podrán compararse directamente desde la interfaz de GitHub para verificar la evolución del proyecto.
